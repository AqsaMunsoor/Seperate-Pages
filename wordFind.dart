...
class _WordFindWidgetState extends State<WordFindWidget> {
            ...
            child: Row(
              ...
              children: [
                ...
                Row(
                  children: [
                    InkWell(
                      onTap: () => generatePuzzle(left: true, loop: []),
                      child: Icon(
                    ...
                    InkWell(
                      onTap: () => generatePuzzle(next: true, loop: []),
                      child: Icon(
  ...
  void generatePuzzle({
    required List<WordFindQues> loop,
    bool next: false,
    bool left: false,
  }) {
